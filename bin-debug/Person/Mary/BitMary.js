    ...
    (function (Mary) {
        var BitMary = (function (_super) {
            ...
            BitMary.prototype.setTexture = function () {
                var factory = new egret.MovieClipDataFactory(RES.getRes('mary_person_json'));
                var data = factory.generateMovieClipData('mary_person_json');
                var sp = new egret.MovieClip(data);
                sp.gotoAndPlay(1, -1);
                this.addChild(sp);
            };
